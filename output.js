    ...
    try {
      _0x199d9c(_0x3afb08, async (_0x29756a, _0x1cbcc1, _0x3e2bff) => {
        if (!_0x29756a && _0x1cbcc1.statusCode === 200) {
          ...
          if (_0x44b02b <= 0) {
            console.log("第", _0x2bf34a + 1, "cookie存在异常，请检查");
            _0x3684a8(null);
          } else {
            _0x3684a8(await _0x1d6167(_0x4b02a4, _0x2bf34a, _0x494579, _0x34c060, _0x44b02b - 1));
          }
        } else {
          _0x3684a8(null);
        }
...
function _0x3359bc(_0xe2284, _0x34930d, _0x562fb3) {
  ...
  for (var _0x2bc831 = _0x562fb3.split(";"), _0x2189aa = 0; _0x2189aa < _0x2bc831.length; _0x2189aa++) {
    ...
    if (["_m_h5_tk", " _m_h5_tk"].indexOf(_0x364b5c[0]) > -1) {
      _0x46ea82 = true;
      _0x2bc831[_0x2189aa] = _0xe2284;
    }
    if ([" _m_h5_tk_enc", "_m_h5_tk_enc"].indexOf(_0x364b5c[0]) > -1) {
      _0x2bc831[_0x2189aa] = _0x34930d;
      _0x46ea82 = true;
    }
  }
  var _0x4c3506 = "";
  if (_0x46ea82) {
    for (_0x2189aa = 0; _0x2189aa < _0x2bc831.length; _0x2189aa++) {
      ...
      if (_0x2189aa != _0x2bc831.length - 1) {
        _0x4c3506 += ";";
      }
    }
  } else {
        ...
        _0x199d9c(_0x46e0b4, async (_0x49016c, _0xd883b9, _0x6b70ae) => {
          if (!_0x49016c && _0xd883b9.statusCode === 200) {
            ...
            if (_0x5dab8d.data.errorCode === "000502") {
              ...
              if (_0x5e7de3 <= 0) {
                console.log("第", _0x20c404 + 1, "cookie存在异常，请检查");
                _0x3c56a0(null);
              }
            ...
            if (_0x49016c && _0x49016c.message.indexOf("Invalid character in header content [\"Cookie\"]") !== -1) {
              console.log("第", _0x20c404 + 1, "账号ck不合法，请确认！！！");
            } else {
              console.log(_0x49016c);
            }
            _0x3c56a0(null);
          }
        });
        ...
        _0x199d9c(_0x14d86f, async (_0x38525d, _0x3d9ba0, _0xd793) => {
          if (!_0x38525d && _0x3d9ba0.statusCode === 200) {
            ...
            if (_0x83e40a.data.errorCode === "000502") {
              ...
              if (_0x83e40a.ret.includes("FAIL_SYS_TOKEN_EXOIRED::令牌过期") || _0x83e40a.ret.includes("FAIL_SYS_TOKEN_EMPTY::令牌为空")) {
                _0x4c5c41(await _0x2fdd22(_0x550593, _0x53145f, _0x3b1b39, _0x29e6ca - 1));
              } else {
                _0x4c5c41(_0x550593);
              }
            }
          } else {
            if (_0x38525d && _0x38525d.message.indexOf("Invalid character in header content [\"Cookie\"]") !== -1) {
      ...
      _0x199d9c(_0x250e1d, async (_0x1a8c62, _0x11340b, _0x5cd710) => {
        if (!_0x1a8c62 && _0x11340b.statusCode === 200) {
          ...
          if (_0x36773b <= 0) {
            ...
            _0x3fd1b5(await _0x1de3c7(_0x40adb5, _0x4a4e41, _0x19be4b, _0x36773b - 1));
          }
        } else {
          _0x3fd1b5(null);
        }
...
function _0x5a5a78(_0x10377c) {
  ...
  for (let _0x59b4d3 of _0x39358d) {
    ...
    if (_0x48a5f4) {
      _0x4c1408.set(_0x48a5f4[1], _0x48a5f4[2]);
    }
  }
  return _0x4c1408;
}
...
const _0x5aea05 = _0x5c0f8f => {
  ...
  return _0x13509e(_0x9917d1 => {
    _0x199d9c(_0xe81482, async (_0x153f07, _0x79cdf0, _0x1c57e0) => {
      if (!_0x153f07 && _0x79cdf0.statusCode === 200) {
        _0x9917d1(JSON.parse(_0x1c57e0));
      } else {
        _0x9917d1({});
      }
    });
...
async function _0x13b336(_0x52aa36, _0x7702a3, _0x65526d, _0x30eead, _0x40f9cf, _0x2f3ac7 = "") {
  ...
  if (_0x4a2ebf.code !== 20000) {
    ...
    if (_0x4a2ebf.message.indexOf("没有车位了") !== -1) {
      process.exit(0);
    }
    return null;
  } else {
  ...
  if (_0x40f9cf) {
    _0x3ffcfc = "https://" + _0x40f9cf + "/gw/" + _0x3587ab + "/1.0/?data=" + encodeURIComponent(_0x46651a) + "&type=originaljson&wua=" + _0x1e8e67;
  }
  const _0x4a1349 = {
    url: _0x3ffcfc,
    headers: _0x581a55,
...
function _0x581038(_0x4bc536, _0x167ae5, _0x4e83b3, _0x47d0b6, _0x47a700, _0x56ac94, _0x2cb8b6, _0x487227) {
  ...
  if (_0x47d0b6) {
    _0x410612.needSignData.sid = _0x47d0b6;
  }
  if (_0x47a700) {
    _0x410612.needSignData.realSID = _0x47a700;
  }
    ...
    _0x199d9c(_0x3295d8, async (_0x6809b3, _0x33640e, _0x1ed939) => {
      if (!_0x6809b3 && _0x33640e.statusCode === 200) {
        try {
          ...
          if (_0x268a3f.code !== 20000) {
            console.log(_0x268a3f.message);
            _0x56b9f0(null);
          } else {
            _0x56b9f0(_0x268a3f.data);
          }
        } catch (_0x15edce) {
